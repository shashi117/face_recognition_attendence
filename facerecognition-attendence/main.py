...
shashi_image = face_recognition.load_image_file("faces/shashi.jpg")
shashi_encoding = face_recognition.face_encodings(shashi_image)[0]

priya_image = face_recognition.load_image_file("faces/jyoti.jpg")
priya_encoding = face_recognition.face_encodings(priya_image)[0]

known_face_encoding = [shashi_encoding, priya_encoding]
known_face_name = ["Shashi", "Priya"]
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if name in known_face_name:
            ...
            thickness = 3
            lineType = 2
            cv2.putText(frame, name + " Present", bottomLeftCornerText, font,
